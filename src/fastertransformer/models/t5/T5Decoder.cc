                           ...
                           float* expert_priority, int* expert_in_cache, int cache_size, int fix_cache_size, float max_val, float threshold, float dec_in_cache, float dec_out_cache, bool use_cache, int& activated_expert_num, int& iter_num, int& cache_hit_num)
{
    ...
    for (uint l = 0; l < num_layer_; l++) {
        ...
        // std::cout << "ddddddddddddddddddexpert_priority[0]: " << expert_priority[0] << std::endl;
        ffn_layer_->forward(&ffn_output_tensors, &ffn_input_tensors, &layer_weight->ffn_weights, l, expert_priority, expert_in_cache, cache_size, fix_cache_size, max_val, threshold, dec_in_cache, dec_out_cache, use_cache, activated_expert_num, iter_num, cache_hit_num);
        // std::cout << "fffffffffffffffffffexpert_priority[0]: " << expert_priority[0] << std::endl;
